...
# 混合任务运行名称
RUN_NAME=AgenticSegRL_Qwen3VL8B_Mixed3Tasks/$(date +%Y%m%d_%H%M%S)

# 核心：将三个数据集路径用逗号分隔传递
# Task 1: base segmentation dataset (原有)
# Task 2: Mask Understanding (Agentic)
# Task 3: Self-Correction (Agentic)
TRAIN_FILES="data/base_segmentation_train,data/hf_agentic/base_dataset/task2,data/hf_agentic/base_dataset/task2,data/hf_agentic/base_dataset/task3"
